<div class="d-flex flex-column p-3 bg-dark text-white vh-100">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        @endif
        <li class="nav-item">
            <a href="{{ route('simpanan.index') }}" class="nav-link text-white">
                <svg class="bi me-2" width="16" height="16" fill="currentColor">
        ...
        <li class="nav-item">
            <a href="{{ route('pinjaman.index') }}" class="nav-link text-white">
                <svg class="bi me-2" width="16" height="16" fill="currentColor">
                    <use xlink:href="#people-circle"></use>
                </svg>
                Pinjaman
        ...
        <li class="nav-item">
            <a href="{{ route('angsuran.index') }}" class="nav-link text-white">
                <svg class="bi me-2" width="16" height="16" fill="currentColor">
                    <use xlink:href="#people-circle"></use>
                </svg>
                Angsuran
        ...
        <li class="nav-item">
            <a href="{{ route('tabungan.index') }}" class="nav-link text-white">
                <svg class="bi me-2" width="16" height="16" fill="currentColor">
                    <use xlink:href="#people-circle"></use>
                </svg>
                Tabungan
        ...
        @if(!Auth::user()->role == 'user' || Auth::user()->role == 'admin')
        <li class="nav-item">
            <a href="{{ route('departemen.index') }}" class="nav-link text-white">
                <svg class="bi me-2" width="16" height="16" fill="currentColor">
                    <use xlink:href="#people-circle"></use>
                </svg>
                Departemen
    ...
    <div class="dropdown">
        ...
        @else
        <p class="text-center text-white">User not authenticated</p>
        @endif
    </div>
</div>
